    ...
    <div className="w-full h-full flex flex-col">
      <div className="flex-shrink-0 px-8 lg:px-12 max-w-4xl mx-auto w-full pt-10">
        ...
        <div className="grid grid-cols-3 gap-3 mb-6">
          <Card
            className="gap-0 py-0 cursor-pointer hover:shadow-md hover:border-primary/30 transition-all duration-200"
        ...
        <Card className="gap-0 py-0 mb-8 overflow-hidden bg-primary border-0 text-primary-foreground">
          <CardContent className="p-0">
            <div className="flex items-center justify-between p-5">
              <div className="flex items-center gap-4">
                <div className="w-10 h-10 rounded-lg bg-primary-foreground/20 backdrop-blur flex items-center justify-center flex-shrink-0">
                  <Microphone size={20} weight="fill" className="text-primary-foreground" />
                </div>
                <div>
                  <div className="text-sm font-semibold mb-0.5">
                    Voice dictation in any app
                  </div>
                  <div className="text-xs text-primary-foreground/80 flex items-center gap-1.5 flex-wrap">
                    <span>Hold</span>
                    {keyboardShortcut.map((key, index) => (
                      <React.Fragment key={index}>
                        <kbd className="inline-flex items-center px-1.5 py-0.5 rounded-md text-[11px] font-mono font-medium bg-primary-foreground/20 border border-primary-foreground/20">
              ...
              <Button
                size="sm"
                className="gap-1.5 rounded-md bg-primary-foreground text-primary hover:bg-primary-foreground/90 font-semibold shadow-none"
                onClick={() =>
        ...
        <DialogContent className="!border-border/50 shadow-xl p-0 max-w-md rounded-xl">
          ...
          <div className="p-7">
            ...
            <div className="grid grid-cols-2 gap-3">
              ...
              <div className="rounded-lg bg-muted/60 p-4">
                <div className="flex items-center gap-2 mb-2">
                  <Rocket size={14} weight="fill" className="text-primary" />
                  <span className="text-[11px] font-semibold tracking-wider text-muted-foreground uppercase">
                    Total Words
                  </span>
                </div>
              ...
              <div className="rounded-lg bg-muted/60 p-4">
                <div className="flex items-center gap-2 mb-2">
                  <Microphone size={14} weight="fill" className="text-primary" />
                  <span className="text-[11px] font-semibold tracking-wider text-muted-foreground uppercase">
                    Sessions
                  </span>
                </div>
